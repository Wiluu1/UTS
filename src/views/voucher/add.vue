    ...
    <div>
        <div class="container">
            ...
            <div class="mt30 row">
                ...
                <div class="w80">        
                    <select class="form-select offappea">
                        <option disabled selected>Pilih Type</option>
                        <option value="1">Super Admin</option>
                        <option value="2">Marketing</option>
                        <option value="3">Sales</option>
                    </select>
                    <div class="p-kanan" ><img class="" src="../../assets/icons/pen-icon.png" alt="" height="20px"></div>   
                </div>
            </div>
            <div class="mt30 row">
                <div class="w20">
                ...
                <div class="w80">
                    <input
                        class="form-text"
                        type="text"
                        placeholder="Masukan Minimal Transaction"
                    >
                </div>
            </div>
            <div class="mt30 row">
            ...
            <div class="flex mt30 bawah">
                <router-link to="/list-voucher">
                    <button class="bt-submit-green">Add Voucher</button>
                </router-link>
            </div>
        </div>
    </div>
